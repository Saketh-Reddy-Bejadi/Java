...
class Calculator {
	...
	int precedence(String x){
		...
		case "x":p=3;break;case "/":p=4;break;
		case "^":p=6;break;case "!":p=7;break;}return p;}
	//operator checking
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(s.charAt(s.length()-1)!= '.') {
					if(num && dot==false) {
						...
						expression+=",.";
						s += ".";}}
				num=true;dot=true;textField.setText(s);}});
